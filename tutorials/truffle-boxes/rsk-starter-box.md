...
If you came from [Truffle box page rsk-starter-box](https://github.com/rsksmart/rsk-starter-box) 
and successfully executed all the instructions over there, you can interact with the published smart contract:
