...
RSK implementation was based in the Java implementation of Ethereum EVM, so a lot of things that we have in Ethereum it is possible to use at RSK network.
