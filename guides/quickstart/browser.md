...
There are currently three well known browser extensions that you can use to interact with the RSK blockchain: MetaMask, Liquality, and [Nifty (discontinued)](https://developers.rsk.co/wallet/use/nifty).
