...
In this guide, you will learn how to create an account and make your first API call, you will also learn how to set limits for the RPC API, and the list of JSON-RPC methods available. 
...
- eth_getLogs
    ...
    - **Constraints:**
        ...
        - Note: It can be filtered either by blockHash OR (fromBlock and toBlock), but not both.
