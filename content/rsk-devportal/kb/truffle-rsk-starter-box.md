...
![test](/assets/img/kb/rsk-starter-box/image-01.png)
...
![simpleStorage.json networks](/assets/img/kb/rsk-starter-box/image-02.png)
...
![simpleStorage.json abi](/assets/img/kb/rsk-starter-box/image-03.png)
...
![simpleStorage set](/assets/img/kb/rsk-starter-box/image-04.png)
...
![Generate a random mnemonic](/assets/img/kb/rsk-starter-box/image-05.png)

The result appears in the `BIP39 Mnemonic` field.
They should be 12 random words like the words in the image:

![BIP39 Mnemonic](/assets/img/kb/rsk-starter-box/image-06.png)
...
![A_MNEMONIC](/assets/img/kb/rsk-starter-box/image-07.png)
...
![minimumGasPrice](/assets/img/kb/rsk-starter-box/image-08.png)
...
![gasPrice](/assets/img/kb/rsk-starter-box/image-09.png)
...
![accounts](/assets/img/kb/rsk-starter-box/image-10.png)
...
![faucet.testnet.rsk.co](/assets/img/kb/rsk-starter-box/image-12.png)

Enter your wallet address and pass the CAPTCHA.

Wait a few seconds…

![Received some RBTCs](/assets/img/kb/rsk-starter-box/image-13.png)
...
![getBalance](/assets/img/kb/rsk-starter-box/image-11.png)
