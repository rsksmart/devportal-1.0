...
![Java Download](/assets/img/kb/geth-attach-local-node/image-01.png)
...
![Download latest RSK release](/assets/img/kb/geth-attach-local-node/image-02.png)
...
![Run local node](/assets/img/kb/geth-attach-local-node/image-03.png)
...
![Geth download page](/assets/img/kb/geth-attach-local-node/image-04.png)

Do the installation with all default options.

> You do not need to install Developer tools.

![Geth install](/assets/img/kb/geth-attach-local-node/image-05.png)
...
![geth version](/assets/img/kb/geth-attach-local-node/image-06.png)
...
![image alt text](/assets/img/kb/geth-attach-local-node/image-07.png)
...
![eth.blockNumber](/assets/img/kb/geth-attach-local-node/image-08.png)
...
![Geth list commands](/assets/img/kb/geth-attach-local-node/image-09.png)
...
![eth.getBlockNumber](/assets/img/kb/geth-attach-local-node/image-10.png)
...
![eth.gasPrice](/assets/img/kb/geth-attach-local-node/image-11.png)
...
![net.version](/assets/img/kb/geth-attach-local-node/image-12.png)
...
![net.peerCount](/assets/img/kb/geth-attach-local-node/image-13.png)
...
![Personal](/assets/img/kb/geth-attach-local-node/image-14.png)
...
![personal.listAccounts](/assets/img/kb/geth-attach-local-node/image-15.png)
...
![eth.accounts](/assets/img/kb/geth-attach-local-node/image-16.png)
...
![personal.newAccount](/assets/img/kb/geth-attach-local-node/image-17.png)
...
![eth.getBalance](/assets/img/kb/geth-attach-local-node/image-18.png)
...
![balance in ethers](/assets/img/kb/geth-attach-local-node/image-19.png)
...
![Balance of a specific account](/assets/img/kb/geth-attach-local-node/image-20.png)
...
![Transfer](/assets/img/kb/geth-attach-local-node/image-21.png)
...
![Balances after transfer](/assets/img/kb/geth-attach-local-node/image-22.png)
...
![exit](/assets/img/kb/geth-attach-local-node/image-23.png)

## Final considerations

Hope it was easy for you to use Geth, an Ethereum client, to interact with an RSK local node.

We can do more things using Geth, such as [deploy a smart contract at RSK local node using Geth and Remix](/kb/geth-attach-deploy-smart-contracts/).
