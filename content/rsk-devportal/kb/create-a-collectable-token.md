...
![create-react-app](/assets/img/kb/create-a-collectable-token/image-01.png)
...
![create-react-app successful installation](/assets/img/kb/create-a-collectable-token/image-02.png)

Now you have a new folder named `app` and we will customize our frontend later.

![create-react-app file structure](/assets/img/kb/create-a-collectable-token/image-03.png)
...
![web3 install](/assets/img/kb/create-a-collectable-token/image-04.png)

![web3 successful installation](/assets/img/kb/create-a-collectable-token/image-05.png)
...
![web3 install](/assets/img/kb/create-a-collectable-token/image-06.png)

As I said before, the option `-E` is to save dependencies with an exact version rather than using npm's default.

![web3 successful installation](/assets/img/kb/create-a-collectable-token/image-07.png)
...
![truffle-config](/assets/img/kb/create-a-collectable-token/image-08.png)
...
![Create Color.sol](/assets/img/kb/create-a-collectable-token/image-09.png)
...
![Color.sol](/assets/img/kb/create-a-collectable-token/image-10.png)
...
![truffle compile](/assets/img/kb/create-a-collectable-token/image-11.png)
...
![create 2_deploy_contracts](/assets/img/kb/create-a-collectable-token/image-12.png)
...
![2_deploy_contracts](/assets/img/kb/create-a-collectable-token/image-13.png)
...
![truffle migrate compile](/assets/img/kb/create-a-collectable-token/image-14.png)

First, it deploys the smart contract `Migrations.sol`, file generated by Truffle:

![truffle migrate Migrations.sol](/assets/img/kb/create-a-collectable-token/image-15.png)
...
![truffle migrate Color.sol](/assets/img/kb/create-a-collectable-token/image-16.png)
...
![index.js](/assets/img/kb/create-a-collectable-token/image-17.png)
...
![App.css](/assets/img/kb/create-a-collectable-token/image-18.png)
...
![npm start](/assets/img/kb/create-a-collectable-token/image-19.png)
...
![localhost:3000](/assets/img/kb/create-a-collectable-token/image-20.png)
...
![authorize Metamask](/assets/img/kb/create-a-collectable-token/image-21.png)

And this is our frontend!

![frontend](/assets/img/kb/create-a-collectable-token/image-22.png)
...
![#FF0000](/assets/img/kb/create-a-collectable-token/image-23.png)

![#FF0000 Metamask confirm](/assets/img/kb/create-a-collectable-token/image-24.png)

Click on the `confirm` button.

Great! Now I have my first color collectable token:

![Red minted](/assets/img/kb/create-a-collectable-token/image-25.png)

I would like to mint the blue color: `#0000FF`

![#0000FF](/assets/img/kb/create-a-collectable-token/image-26.png)

Wait for a few seconds for your transaction to be mined…

And now I have two colors in my collection!

![Blue minted](/assets/img/kb/create-a-collectable-token/image-27.png)

And my collection is growing!

![color collection](/assets/img/kb/create-a-collectable-token/image-28.png)
