...
<div style="text-align:center"><img src="/assets/img/kb/create-a-token-02/create-token1.png"></div>
...
* 6.3.3 Submit form.
  <div style="text-align:center"><img style="margin:0 auto" src="/assets/img/kb/create-a-token-02/create-token5.png"></div>
