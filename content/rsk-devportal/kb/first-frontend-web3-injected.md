...
* [using Remix and Metamask with RSK testnet](/kb/remix-and-metamask-with-rsk-testnet/)
...
![node and npm version](/assets/img/kb/first-frontend-web3-injected/image-01.png)
...
![visual code version](/assets/img/kb/first-frontend-web3-injected/image-02.png)
...
![Register project](/assets/img/kb/first-frontend-web3-injected/image-03.png)
...
![package.json](/assets/img/kb/first-frontend-web3-injected/image-04.png)
...
![Remix Homepage](/assets/img/kb/first-frontend-web3-injected/image-15.png)
...
![Solidity Compiler](/assets/img/kb/first-frontend-web3-injected/image-14.png)

Click the button **Compile Register.sol**.

![Compile Register.sol](/assets/img/kb/first-frontend-web3-injected/image-16.png)
...
![Deploy and run transactions](/assets/img/kb/first-frontend-web3-injected/image-05.png)

> Ensure that you have tRBTC in your wallet, as this is needed to pay gas fees when deploying the smart contracts. To do so, please follow this guide: [Using Remix and Metamask with RSK testnet](/kb/remix-and-metamask-with-rsk-testnet/).
...
![Copy](/assets/img/kb/first-frontend-web3-injected/image-06.png)

![smart contract address](/assets/img/kb/first-frontend-web3-injected/image-07.png)
...
![node server.js](/assets/img/kb/first-frontend-web3-injected/image-08.png)
...
![register frontend](/assets/img/kb/first-frontend-web3-injected/image-17.png)
...
![getInfo](/assets/img/kb/first-frontend-web3-injected/image-10.png)
...
![setInfo](/assets/img/kb/first-frontend-web3-injected/image-11.png)
...
![getInfo again](/assets/img/kb/first-frontend-web3-injected/image-12.png)
