...
Already familiar with Web3 development and solidity and setting up a Hardhat project? In this guide, you can skip to [Part 2, Section 2](/guides/quickstart/hardhat/create-smart-contract/) to configure your Hardhat project for the Rootstock network.
