...
Already familiar with Web3 development and solidity and setting up a Hardhat project? You can skip to [Part 2, Section 2](/guides/quickstart/hardhat/create-smart-contract/) in this guide to configure your Hardhat project for the Rootstock network.
